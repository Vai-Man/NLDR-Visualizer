...
penguins_scaled <- penguins %>%
  mutate(across(where(is.numeric), scale))  # Standardizing numeric columns


penguins <- na.omit(palmerpenguins::penguins)
tour_data <- penguins_scaled[, c("bill_length_mm", "bill_depth_mm", "flipper_length_mm", "body_mass_g", "species")]
